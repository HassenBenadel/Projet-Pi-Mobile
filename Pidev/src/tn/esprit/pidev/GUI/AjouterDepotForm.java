 ...
 * @author Ibtihel
 */
public class AjouterDepotForm extends Form{
    Form current;
    
    ServiceDepot dS = new ServiceDepot();
    ServiceLivraison lS = new ServiceLivraison();

    public AjouterDepotForm(Form  previous) {
        
         setTitle("Ajouter Depot");
        ...
        adresse_field.setHint("entrez l'adresse");
        ...
        quantite_field.setHint("entrez la quantite");
        ...
        disponibilite_field.setHint("Disponible ou Non");
        ...
        TextField idProduit_field = new TextField("");
         idProduit_field.setHint("entrez l'id du produit");
        ...
        cnt_idProduit.add(BorderLayout.CENTER,  idProduit_field);
         ...
         ComboBox livraison = new ComboBox();
          livraison.setHint("Choisir la livraison");
        ...
        Button btn_ajouterDepot = new Button("Ajouter");
        btn_ajouterDepot.addActionListener(new ActionListener() {
            @Override
       ...
       Container cnt_button = new Container(new BorderLayout());
        ...
        cnt_button.add(BorderLayout.EAST,btn_ajouterDepot);
