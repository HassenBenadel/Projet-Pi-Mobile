...
public class ModifierLivraisonForm extends Form{
    ...
    public ModifierLivraisonForm(Form previous,Livraison f) {
     setTitle("Modifier Livraison");
        ...
        prix_field.setText(f.getPrix_total());
        ...
        modepaiement_field.setSelectCommandText(f.getMode_paiement());
        ...
        idCommande_field.setText(String.valueOf(f.getId_commande()));
        ...
        //p.setDate(dt);
         ...
         ComboBox livreur = new ComboBox();
          livreur.setHint(String.valueOf(f.getId_livreur().getId_livreur()));
        ...
        btn_updateLivraison.addActionListener(new ActionListener() {
            ...
            l.setId_livraison(f.getId_livraison());
        ...
        cnt_button.add(BorderLayout.EAST,btn_updateLivraison);
